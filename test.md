...
| [VL-BERT](https://arxiv.org/abs/1908.08530) | 2019 | Single-Transformer | Enhances cross-modal reasoning with unified visual-language pretraining | Pretraining + fine-tuning |
| [UNITER](https://doi.org/10.1007/978-3-030-58577-8_7) | 2020 | Single-Transformer | Reasons via joint contextual encoding in a single Transformer backbone | Pretraining + fine-tuning |
| [BLIP-2](https://proceedings.mlr.press/v202/li23q.html) | 2023 | Single-Transformer | Uses a querying Transformer for improved cross-modal reasoning efficiency | Pretraining + fine-tuning |
...
| **Name** | **Modality** | **Task** | **Reasoning Structure** | **Highlight** |
|:---------|:-------------|:---------|:------------------------|:--------------|
...
| [TextCoT](https://arxiv.org/abs/2404.09797) | T,I | VQA | Caption, Localization, Observation | First summarizes visual context, then generates CoT-based responses |
...
| [CoTDet](https://doi.org/10.1109/ICCV51070.2023.00285) | I,T | object detection | Object listing, Affordance analysis | Achieves object detection via human-like procedure |
...
| **Name** | **Modality** | **Task** | **Enhancement Type** | **Highlight** |
|:---------|:-------------|:---------|:---------------------|:--------------|
| MM-ToT | T,I | Image Generation | Search Algorithm | Applies DFS and BFS to select optimal outputs |
| [HoT](https://arxiv.org/abs/2308.06207) | T,I | VQA | Search Algorithm | Generates linked thoughts from multimodal data in a hyperedge |
| [L3GO](https://arxiv.org/abs/2402.09052) | T,I | 3D Object Generation | Tools | Iterative part-based 3D construction through LLM reasoning |
| [Chain-of-Image](https://arxiv.org/abs/2311.09241) | T,I | Geometric reasoning | Tools | Generates intermediate images during reasoning for visual pattern recognition |
| [RAGAR](https://arxiv.org/abs/2404.12065) | T,I | Political Fact-Checking | RAG | Integrates MLLMs with retrieval-augmented reasoning |
...
|:---------|:-------------|:--------------------------|:---------|:--------------|
| [IdealGPT](https://doi.org/10.18653/v1/2023.findings-emnlp.755) | T, I | Answer sub-questions about image via gpt | VQA | Using gpt to iteratively decompose and solve visual reasoning tasks |
| [AssistGPT](https://arxiv.org/abs/2301.12597) | T, I, V | Plan, Execute, Inspect via External Tools | VQA | Using an interleaved code and language reasoning approach |
| [MM-REACT](https://arxiv.org/abs/2303.11381) | T, I, V | Use CV tools for sub-tasks about image | VQA | Vision experts combined with GPT for multimodal reasoning and action |
| [Image-of-Thought](https://arxiv.org/abs/2405.13872) | T, I | Extract visual rationales step-by-step | VQA | Using visual rationales to enhance LLMs' reasoning accuracy |
| [MVoT](https://arxiv.org/abs/2501.07542) | T, I | Model-Intrinsic Capabilities | Spatial Reasoning | Using multimodal reasoning with image visualizations |
...
| **Name** | **Backbone** | **Dataset** | **Modality** | **Reasoning Paradigm** | **Highlight** |
|:---------|:-------------|:------------|:-------------|:-----------------------|:--------------|
| [Macro-O1](https://doi.org/10.48550/arXiv.2411.14405) | Qwen2-7B-Instruct | Open-O1 CoT + Marco-o1 | T | MCTS-guided Thinking | MCTS for solution expansion and reasoning action strategy |
| [LLaVA-CoT](https://arxiv.org/abs/2411.10440) | Llama-3.2V-11B-cot | LLaVA-CoT-100k | T, I | Summary, Caption, Thinking | Introduce LLaVA-CoT-100k and scalable beam search |
| [Mulberry](https://arxiv.org/abs/2412.18319) | Llama-3.2V, LLaVA-Next, Qwen2-VL | Mulberry-260K | T, I | Caption, Rationales, Thinking | Introduce Mulberry-260k and CoMCTS for collective learning |
| [RedStar-Geo](https://arxiv.org/abs/2501.11284) | InternVL2-8B | GeoQA | T, I | Long-Thinking | Competitive with minimal Long-CoT data |
...
| [MMBench](https://doi.org/10.1007/978-3-031-72658-3_13), [Seed-Bench](https://doi.org/10.48550/arXiv.2307.16125) | [MS-COCO](https://doi.org/10.1007/978-3-319-10602-1_48), [Virpt](https://arxiv.org/abs/2406.06040) |
...
| [Fleurs](https://doi.org/10.1109/SLT54892.2023.10023141), [MusicBench](https://doi.org/10.18653/v1/2024.naacl-long.459) | [Aishell](https://doi.org/10.1109/ICSDA.2017.8384449), [MELD](https://doi.org/10.18653/v1/p19-1050) |
...
| **Benchmark** | **Dataset** |
|:--------------|:------------|
| [GenEval](http://papers.nips.cc/paper_files/paper/2023/hash/a3bf71c7c63f0c3bcb7ff67c67b1e7b1-Abstract-Datasets_and_Benchmarks.html), T2I-CompBench++ | [MS-COCO](https://doi.org/10.1007/978-3-319-10602-1_48), [Flickr30k](https://doi.org/10.1007/s11263-016-0965-7) |
...
| [ScienceQA](http://papers.nips.cc/paper_files/paper/2022/hash/11332b6b6cf4485b84afadb1352d3a9a-Abstract-Conference.html), [ChartQA](https://doi.org/10.18653/v1/2022.findings-acl.177) | [GeoQA](https://arxiv.org/abs/2105.14517), [Gibson](http://openaccess.thecvf.com/content_cvpr_2018/html/Xia_Gibson_Env_Real-World_CVPR_2018_paper.html) |
...
| **Benchmark** | **Dataset** |
|:--------------|:------------|
| [WebArena](https://openreview.net/forum?id=oKn9c6ytLx), [Mind2Web](http://papers.nips.cc/paper_files/paper/2023/hash/5950bf290a1570ea401bf98882128160-Abstract-Datasets_and_Benchmarks.html) | [AMEX](https://doi.org/10.48550/arXiv.2407.17490), [RiCo](https://doi.org/10.1145/3126594.3126662) |
