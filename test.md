...
[![GitHub Repo stars](https://img.shields.io/github/stars/your-username/your-repo?style=social)](https://github.com/your-username/your-repo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) <br>
**[Project Page [This Repository]](https://github.com/your-username/your-repo)** | **[Paper](https://arxiv.org/abs/xxxx.xxxx)** | **[✒️ Citation](#citation)** | **[🤝 Contributing](#contributing)**
...
## ✨ About
This repository serves as the project page for the survey paper **"Perception, Reason, Think, and Plan: A Survey on Large Multimodal Reasoning Models"**. It provides supplementary resources, links to datasets/benchmarks, and aims to be a living collection related to advancements in Multimodal Reasoning Models.

<p align="center">
  <img src="images/intro.png" alt="Roadmap of Large Multimodal Reasoning Models" width="800" />
  <br>
  <em>Figure 1: The roadmap of large multimodal reasoning models.</em>
</p>
...
- [🗺️ 2 Roadmap of Multimodal Reasoning Models](#️-2-roadmap-of-multimodal-reasoning-models)
...
- [💡 3 Towards Native Multimodal Reasoning Model](#-3-towards-native-multimodal-reasoning-model)
    - [3.1 Experimental Findings (O3/O4-mini Evaluation)](#31-evaluation-of-o3-and-o4-mini)
...
## 🗺️ 2 Roadmap of Multimodal Reasoning Models
...
| [HeteroMemory](http://openaccess.thecvf.com/content_CVPR_2019/html/Fan_Heterogeneous_Memory_Enhanced_Multimodal_Attention_Model_for_Video_Youtubeing_CVPR_2019_paper.html) | 2019 | Memory-based | Synchronizes appearance and motion modules for video-based temporal reasoning. | Supervised learning |
...
With the advent of large-scale multimodal pretraining, MLLMs have started to demonstrate emergent reasoning capabilities. However, such inferences are often shallow, relying primarily on implicit correlations rather than explicit logical processes. To mitigate this limitation, **Multimodal Chain-of-Thought (MCoT)** has emerged as a simple yet effective approach. By incorporating intermediate reasoning steps, MCoT improves cross-modal alignment, knowledge integration, and contextual grounding, all without the need for extensive supervision or significant architectural modifications. In this stage, we categorize existing approaches into three paradigms: prompt-based MCoT, structural reasoning with predefined patterns, and tool-augmented reasoning leveraging lightweight external modules.

<p align="center">
  <img src="images/stage2.png" alt="Taxonomy of structural reasoning in MCoT" width="800" />
  <br>
...
*(Content for this section would go here if available in the source document)*
...
| [AVQA-CoT](https://sightsound.org/papers/2024/Li_AVQA-CoT_When_CoT_Meets_Youtubeing_in_Audio-Visual_Scenarios.pdf) | T,A,V | AVQA | Question Deconstruct, Question Selection, Rationale | MUSIC-AVQA | Decomposes complex questions into multiple simpler sub-questions and leverages LLMs to select relevant sub-questions for audio-visual question answering. |
...
<p align="center">
  <img src="images/stage3_o1_and_r1.png" alt="Emergence of Advanced O1 and R1 Models" width="800" />
  <br>
  <em>Figure 3: The Emergence of Advanced O1 and R1 Multimodal Reasoning Models (2024-2025).</em>
</p>
...
<p align="center">
  <img src="images/O3-evaluation1.png" alt="O3 Long-form Reasoning Example" width="700" />
</p>
...
<p align="center">
  <img src="images/O3-evaluation2.png" alt="O3 Visual Problem Solving Example" width="700" />
</p>
...
<p align="center">
  <img src="images/O3-evaluation3.png" alt="O3 Location Finding and Puzzle Solving Example" width="700" />
</p>
...
*[Content for Section 3.2: Model Capability]*

*(Please add details here about the desired or current capabilities of Native LMRMs, potentially covering aspects like few-shot learning, robustness, generalizability across modalities, real-time interaction, etc.)*

### 3.3 Technical Prospects

*[Content for Section 3.3: Technical Prospects]*

*(Please add details here about the technical challenges, future research directions, and potential breakthroughs needed for advancing N-LMRMs. This could include architecture design, training strategies, data requirements, evaluation methods, ethical considerations, etc.)*
...
<details>
<summary><b>Click to expand Datasets and Benchmarks Tables</b></summary>
...
| [MM-IFEval](https://arxiv.org/abs/2504.07957), [All-Angles Bench](https://arxiv.org/abs/2504.15280) | [CLIP](http://proceedings.mlr.press/v139/radford21a.html), [YouTube8M](https://arxiv.org/abs/1609.08675) |
...
| [AIGCBench](http://openaccess.thecvf.com/content_CVPR_2019/html/Fan_Heterogeneous_Memory_Enhanced_Multimodal_Attention_Model_for_Video_Youtubeing_CVPR_2019_paper.html), [EvalCrafter](https://doi.org/10.1109/CVPR52733.2024.02090) | [LWM](https://doi.org/10.48550/arXiv.2402.08268), [Genesis](https://github.com/Genesis-Embodied-AI/Genesis) |
...
*[Content for Section 4.5: Evaluation Method]*

*(Please add details here about the methods used to evaluate the performance of LMRMs. This could include common metrics like Accuracy, F1-score, BLEU, ROUGE, CIDEr for generation tasks, VQA accuracy, grounding accuracy, success rate in embodied tasks, human evaluation protocols, specific benchmark scoring methods, etc.)*
...
Building on empirical evaluations and experimental insights, we propose a forward-looking framework for **inherently multimodal large models (N-LMRMs)** that transcend language-dominated architectures. Such models should prioritize three core capabilities:
...
*(Update the license type and link if necessary. Ensure a LICENSE file exists in your repository.)*
...
*(Ensure a CONTRIBUTING.md file exists if you want to accept contributions.)*
...
@article{author2025perception,
  ...
  author={Author, First and Author, Second},  -- PLEASE UPDATE AUTHORS
  journal={arXiv preprint arXiv:xxxx.xxxx},    -- PLEASE UPDATE ARXIV ID
  year={2024}                                -- Check/Update Year
}
